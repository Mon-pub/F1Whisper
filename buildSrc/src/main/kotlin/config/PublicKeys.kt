...
object PublicKeys {
    ...
    // Self-hosted OnPrem deployment: trust ONLY our own OPPF Ed25519 signing key. Replacing this
    // value repoints the app's provisioning trust anchor, so a build of this repository will not
    // accept a configuration signed by anyone else. The matching private key is held by the
    // operator of the deployment and never appears in this repository.
    val onPremTrusted = arrayOf(
        "2+AXErG+lLsSedZIld94vlxfW9tBzIqVLE7YK7ALrf4=",
    )
